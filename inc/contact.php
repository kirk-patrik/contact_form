...
<head>
    ...
    <style type="text/css">
        ...
        input[type='checkbox'] {
            ...
            outline: none;
            border-radius: 2px;
            box-shadow: 0 0 0 2px rgb(217 218 218);
            position: relative;
        }
        ...
        input[type='checkbox']:checked {
            ...
            box-shadow: 0 0 0 2px #0075FF !important;
        }
    </style>
...
<body>
    ...
    <main>
        ...
        <section class="contact_form">
            <div class="">
                <div style="background-color: #33b9bb;" class="site-heading">
                    ...
                    <form method="post" action="#form" enctype="multipart/form-data" novalidate class="txt_left">
                        ...
                        <div>
                            ...
                            <input type="text" class="validate[required] block width_100 font_75 txt_tpad_1 txt_bpad_1 txt_lpad_1 txt_rpad_1" placeholder="お名前を入力してください" value="<?php if (!empty($clean['your_name'])) {
                                                                                                                                                                                ...
                                                                                                                                                                                } ?>" style=" <?= !empty($error['your_name']) ? 'border: 2px solid red; border-radius: 4px; outline: none; background-color: rgb(234, 235, 234)' : 'border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;' ?>   " id="input-name" name="your_name">
                            <?php if (!empty($error['your_name'])) : ?><p class="error_msg bold txt_left font_65 txt_tpad_05 mg_auto">
                        ...
                        <div>
                            ...
                            <input type="text" class="validate[required] block width_100 font_75 txt_tpad_1 txt_bpad_1 txt_lpad_1 txt_rpad_1" placeholder="メールアドレスを入力してください" value="<?php if (!empty($clean['email'])) {
                                                                                                                                                                                        echo $clean['email'];
                                                                                                                                                                                    } ?>" style=" <?= !empty($error['email']) ? 'border: 2px solid red; border-radius: 4px; outline: none; background-color: rgb(234, 235, 234)' : 'border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;' ?>   " id="input-email" name="email">
                            <?php if (!empty($error['email'])) : ?><p class="error_msg bold txt_left font_65 txt_tpad_05 mg_auto">
                        ...
                        <div>
                            ...
                            <?php if (!empty($error['company_name'])) : ?><p class="error_msg bold txt_left font_65 txt_tpad_05 mg_auto">
                        ...
                        <div>
                            ...
                            <div class="space_05"></div>
                            <textarea name="contents" id="input-text" class="validate[required] width_100 font_75 txt_tpad_1 txt_lpad_1 txt_bpad_1 txt_rpad_1" placeholder="例）電話で詳細を聞きたい" rows="5" style="border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;"><?php if (!empty($clean['contents'])) {
                                                                                                                                                                                                                                                                                        echo $clean['contents'];
                                                                                                                                                                                                                                                                                    } ?></textarea>
                        ...
                        <div class="txt_tpad_05 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="同意する。" class="validate[required]" id="agreement" name="agreement" style="cursor: pointer;  opacity: .6;">
                            ...
                            <?php if (!empty($error['agreement'])) : ?>
                                <div class="space_05"></div>
                                <p class="error_msg bold txt_left font_65 txt_tpad_05 mg_auto width_100">
                        ...
                        <div class="txt_center">
                            <button type="submit" name="btn_submit" value="内容を送信" class="custom_hover font_75 txt_tpad_1 txt_bpad_1 white" style="font-family: arial,helvetica,clean,sans-serif; width: 12vw; border-radius: 13vw; border: none; background-color: #ff9500; cursor: pointer;">内容を送信</button>
                        </div>
                    </form>
