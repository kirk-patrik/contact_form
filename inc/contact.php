        ...
        <section class="contact_form">
            <div class="">
                ...
                <div class="cont_wrapper_50">
                    <form method="post" action="#form" enctype="multipart/form-data" novalidate class="txt_left txt_lpad_4 txt_rpad_4">
                        <label class="font_75 noto_bold txt_5th_color">複数選択（チェックボックス）<span class="red bold">*</span></label>
                        <div class="txt_tpad_05 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="無料相談" name="customer_attr" class="validate[required]" style="cursor: pointer; width:14px; height: 14px; opacity: .6" <?php if (!empty($clean['customer_attr']) && $clean['customer_attr'] === "無料相談") {
                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                } ?>>
                        ...
                        <div class="txt_tpad_1 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="資料請求" name="customer_attr" class="validate[required]" style="cursor: pointer; width:14px; height: 14px; opacity: .6" <?php if (!empty($clean['customer_attr']) && $clean['customer_attr'] === "資料請求") {
                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                } ?>>
                        ...
                        <div class="txt_tpad_1 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="オンラインにてデモをご希望" name="customer_attr" class="validate[required]" style="cursor: pointer; width:14px; height: 14px; opacity: .6" <?php if (!empty($clean['customer_attr']) && $clean['customer_attr'] === "オンラインにてデモをご希望") {
                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                        } ?>>
                        ...
                        <div class="txt_tpad_1 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="その他　※詳細はお問い合わせ内容欄に入力をお願いします。" name="customer_attr" class="validate[required]" style="cursor: pointer; width:14px; height: 14px; opacity: .6" <?php if (!empty($clean['customer_attr']) && $clean['customer_attr'] === "その他　※詳細はお問い合わせ内容欄に入力をお願いします。") {
                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                        } ?>>
                            <label class="noto_regular txt_5th_color font_75 txt_lpad_05">その他　※詳細はお問い合わせ内容欄に入力をお願いします。</label>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space_05"></div>
                            <input type="text" class="validate[required] block width_100 font_75 txt_tpad_1 txt_bpad_1 txt_lpad_1 txt_rpad_1" placeholder="お名前を入力してください" value="<?php if (!empty($clean['your_name'])) {
                                                                                                                                                                                    echo $clean['your_name'];
                                                                                                                                                                                } ?>" style="border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;" id="input-name" name="your_name">
                            <?php if (!empty($error['your_name'])) : ?><p class="error_msg bold txt_left font_75" style="margin: 0; padding-top: 5px;">
                        ...
                        <div>
                            ...
                            <div class="space_05"></div>
                            <input type="text" class="validate[required] block width_100 font_75 txt_tpad_1 txt_bpad_1 txt_lpad_1 txt_rpad_1" placeholder="メールアドレスを入力してください" value="<?php if (!empty($clean['email'])) {
                                                                                                                                                                                        echo $clean['email'];
                                                                                                                                                                                    } ?>" style="border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;" id="input-email" name="email">
                            <?php if (!empty($error['email'])) : ?><p class="error_msg bold txt_left font_75" style="margin: 0; padding-top: 5px;">
                        ...
                        <div>
                            ...
                            <div class="space_05"></div>
                            <input type="text" name="company_name" id="input-company" class="validate[required] block width_100 font_75 txt_tpad_1 txt_bpad_1 txt_lpad_1 txt_rpad_1" placeholder="会社名を入力してください" value="<?php if (!empty($clean['company_name'])) {
                                                                                                                                                                                                                            echo $clean['company_name'];
                                                                                                                                                                                                                        } ?>" style="border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;">
                            <?php if (!empty($error['company_name'])) : ?><p class="error_msg bold txt_left font_75" style="margin: 0; padding-top: 5px;">
                        ...
                        <div>
                            ...
                            <?php if (!empty($error['tel'])) : ?><p class="error_msg bold txt_left font_75" style="margin: 0; padding-top: 5px;">
                        ...
                        <div>
                            ...
                            <div class="space_05"></div>
                            <textarea name="contents" id="input-text" class="validate[required] width_100 txt_tpad_1 txt_lpad_1 txt_bpad_1 txt_rpad_1" placeholder="例）電話で詳細を聞きたい" rows="5" style="border: 1px solid rgba(0,0,0,.15); border-radius: 4px; outline: none;"><?php if (!empty($clean['contents'])) {
                                                                                                                                                                                                                                                                                echo $clean['contents'];
                                                                                                                                                                                                                                                                            } ?></textarea>
                            <?php if (!empty($error['contents'])) : ?><p class="error_msg bold txt_left font_75" style="margin: 0; padding-top: 5px;">
                        ...
                        <div class="txt_tpad_05 flex" style="align-items: center; justify-content: flex-start;">
                            <input type="checkbox" value="同意する。" class="validate[required]" id="agreement" name="agreement" style="cursor: pointer; width: 0.9375vw; height: 0.9375vw; opacity: .6;">
                        ...
                        <div class="txt_center">
                            <button type="submit" name="btn_confirm" value="内容を送信" class="custom_hover font_75 txt_tpad_1 txt_bpad_1 white" style="font-family: arial,helvetica,clean,sans-serif; width: 12vw; border-radius: 13vw; border: none; background-color: #ff9500; cursor: pointer;">内容を送信</button>
                        </div>
                    </form>
