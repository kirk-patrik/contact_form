...
<body>
        ...
        <section class="thanks_page">
            <div class="view_pc">
                <!-- header -->
                <div style="background-color: #5eb6b8;">
                        <div class="bg_img width_25">
                            <div class="txt_lpad_5">
                ...
                <div class="cont_wrapper_50">
                    <div class="flex flex_center txt_tpad_5" style="justify-content: center; flex-direction: column;">
                        <div class="width_20">
                            <img src="img/thanks_page_img1.png" alt="" class="fix_zoom undrag">
                        </div>
                        <p class="font_200 bold txt_tpad_1" style="color: #5eb6b8; margin: 0 !important;">お問い合わせ完了しました!!</p>
                        <p class="txt_center font_125 bold" style="color:#4c4c4c">
                            お問い合わせ頂きありがとうございます。<br> 弊社スタッフよりご連絡させていただきます。 
                        </p>
                    </div>
                </div>
                <!-- spacing -->
                ...
                <!-- footer -->
                <footer class="txt_center" style="background-color: #5eb6b8;">
                    <p class="white txt_tpad_2 font_75 bold" style="margin:0;">運営会社</p>
                    <p class="white txt_bpad_1 txt_tpad_05 font_75 bold" style="margin:0;">©2021 Locaop. All Rights Reserved.</p>
                </footer>
            </div>
             ...
             <div class="view_tabsp">
                ...
                <div style="background-color: #5eb6b8;">
                            ...
                            <div class="txt_lpad_3 width_40">
                                <img src="img/logo.png" alt="" class="fix_zoom undrag">
                            </div>
                </div>
                <!-- body -->
                <div class="cont_wrapper_50">
                    <div class="flex flex_center txt_tpad_5" style="justify-content: center; flex-direction: column;">
                        <div class="bg_img undrag width_30">
                            <img src="img/thanks_page_img1.png" alt="">
                        </div>
                        <p class="font_150 bold txt_tpad_1" style="color: #5eb6b8; margin: 0 !important;">お問い合わせ完了しました!!</p>
                        <p class="txt_center font_100 bold" style="color:#4c4c4c">
                            お問い合わせ頂きありがとうございます。<br> 弊社スタッフよりご連絡させていただきます。 
                        </p>
                    </div>
                </div>
                ...
                <footer class="txt_center" style="background-color: #5eb6b8;">
                    ...
                    <p class="white txt_bpad_2 txt_tpad_05 font_75 bold" style="margin:0;">©2021 Locaop. All Rights Reserved.</p>
                </footer>
            </div>
        </section>
